<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="HPIT.Logistic.PM.WebApp.Admin.AddUser" %>
        ...
        <section class="content">
            <div class="box-body">
                <div class="form-group">
                   <label for="exampleInputPassword1">登录名</label>
                   <asp:TextBox ID="TextBox_Account" class="form-control" runat="server"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">密码</label>
                    <asp:TextBox ID="TextBox_Password" class="form-control" runat="server"></asp:TextBox>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <asp:TextBox ID="TextBox_Born" class="form-control " ClientIDMode="Static"  runat="server"></asp:TextBox>
                </div>
                <div>
            ...
            <div class="box-footer">
                <asp:Button ID="Button_Add" CssClass="btn btn-default" runat="server" Text="保存" OnClick="Button_Add_Click" />
